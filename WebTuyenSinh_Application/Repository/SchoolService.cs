            ...
            List<School> request1 = new List<School>();
                foreach (var item in request)
                {
                    ...
                    x.idDistrict.Equals(item.idDistrict)
                        ...
                        if (school != null )
                        {
                        if (school.Adrees != item.Adrees || school.NameConscious!=item.NameConscious || school.NameDistrict!=item.NameDistrict || school.NameShool!= item.NameShool|| school.Area!= item.Area)
                        {
