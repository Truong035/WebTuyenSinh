        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreateDate = table.Column<DateTime>(fixedLength: true, nullable: true, defaultValue: new DateTime(2022, 3, 8, 21, 4, 12, 789, DateTimeKind.Local).AddTicks(9900)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(nullable: true),
                    imgavata = table.Column<string>(maxLength: 500, nullable: true),
                    ...
                    Identification = table.Column<string>(maxLength: 20, nullable: true),
                    Mark = table.Column<double>(nullable: true),
                    IdBlock = table.Column<string>(maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    idRole = table.Column<long>(nullable: true),
                    idPermisstion = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Role_Permisstion", x => x.id);
                    table.ForeignKey(
                        name: "FK_Role_Permisstion_Permisstion_idPermisstion",
                        column: x => x.idPermisstion,
                        principalTable: "Permisstion",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Role_Permisstion_Role_idRole",
                        column: x => x.idRole,
                        principalTable: "Role",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pass = table.Column<string>(maxLength: 500, nullable: true),
                    CreateDate = table.Column<DateTime>(nullable: true),
                    idRole = table.Column<long>(nullable: true),
                    delete = table.Column<bool>(nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Role_Permisstion_idPermisstion",
                table: "Role_Permisstion",
                column: "idPermisstion");

            migrationBuilder.CreateIndex(
                name: "IX_Role_Permisstion_idRole",
                table: "Role_Permisstion",
                column: "idRole");
